...
class ebpfCode:
    ...
    def __set_variable__(self):
        self.param_pos["sock_sendmsg"] = "struct socket *sock = (struct socket *)PT_REGS_PARM1(ctx); struct sock *sk = sock->sk;  size_t size = (size_t)PT_REGS_PARM3(ctx);"
        self.param_pos["kernel_sendpage"] = "struct socket *sock = (struct socket *)PT_REGS_PARM1(ctx); struct sock *sk = sock->sk; size_t size = (size_t)PT_REGS_PARM4(ctx);"
        ...
        self.param_pos["napi_gro_receive"] = "struct sk_buff *skb = (struct sk_buff *)PT_REGS_PARM2(ctx);"
        ...
        self.func_type["napi_gro_receive"] = 4
        ...
        if self.evt_type.get("__netif_receive_skb_core") != None and self.evt_type.get("napi_gro_receive") != None:
            self.evt_type["__netif_receive_skb_core"] = self.evt_type["napi_gro_receive"]
